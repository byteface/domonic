"""
	...
	# xxx.xxx = remove Event Listener
	# xxx.xxx = dispatch Event

	# even had the idea of doing all the python builtins and list methods etc.
	# but that would be too much and should be another pypi package if not already exists.
