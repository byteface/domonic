...
def create_element(name: str = "atom_element", *args: Any, **kwargs: Any) -> AtomElement:
    ...
    custom_atom_tag = type("atom_element", (AtomElement,), {"name": tag_name, "__module__": __name__})
