...
| Web APIs | URL, URLSearchParams, URLPattern, storage, Cookie Store, history, scheduler/postTask helpers, fetch-style helpers, forms, WebMCP declarative attributes, import maps, speculation rules, attribution hints, compression streams, XPath, SSE, WebSocket, permissions, media, and performance APIs |
