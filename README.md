...
| Web APIs | URL, URLSearchParams, URLPattern, storage, history, fetch-style helpers, forms, WebMCP declarative attributes, XPath, SSE, WebSocket, permissions, media, and performance APIs |
