...
page = lambda content: html(_lang="en", _class="no-js", _dir="auto").html(
    head(
        ...
        script(_type="text/javascript", _src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.52.2/codemirror.min.js"),
        script(_type="text/javascript", _src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.52.2/mode/python/python.min.js"),
