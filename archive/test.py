...
output = html(
        head(
            ...
            link(_rel="stylesheet", _type="text/css", _href="https://cdnjs.cloudflare.com/ajax/libs/milligram/1.3.0/milligram.css"),
            style(css),script(js),
        ),
        body(
            header( a(
                img(_width="149", _height="149", _src="https://github.blog/wp-content/uploads/2008/12/forkme_right_white_ffffff.png?resize=149%2C149", 
                    _class="attachment-full size-full", _alt="Fork me on GitHub", _style="float:right;", 
                    **{'_data-recalc-dims':'1'}
                ),
                _href=repo,
            )),
            article(
                ...
                a(" go to the repo >>", _href=repo, _style="font-size:15px;"), br(),br(),
                nav("Nav:", a("Go back to here again",_href=""), "|", a("repo",_href=repo) ), br(),
                img(_src="http://placekitten.com/400/400", _alt="some text", _title="some text"), br(),
            ...
            section(
                figure(
                    img(_src="http://placekitten.com/200/200", _alt="some text", _title="some text"), br(),
                ),
                figcaption("a cat"), br(),
                dl(
                    dt("coffee"),
                ...
                form(
                    label("this is a label:", _for="some_input"), br(),
                    input(_id="some_input", _name="some_input", _type="text", _placeholder="cool"), br(),
                    input(" yer or no?", _type="radio"), br(),
            ...
            footer(
                ...
                button("cool button"),sup("sup!"),sub("sub!"),
                textarea("test"),
                details(
                    summary(
                        small("domonic 2020.")
